...
export const legalContent = {
  terms: {
    ...
    body: [
      ...
      "",
      "### Recruitment and Certificate of Sponsorship administration",
      "",
      "The company service fee covers recruitment coordination and administration of your Certificate of Sponsorship. UK government and third-party immigration costs are quoted separately before payment.",
      "",
      "A Certificate of Sponsorship does not guarantee employment or visa approval.",
      "",
      "### Plans and payment",
      "",
      "Two support terms are available:",
      "",
