...
export const metadata: Metadata = {
  title: "Privacy Notice for Applicants | Bupa Care Jobs",
  description: "Privacy notice for applicants using Bupa Care Jobs.",
};
...
export default function PrivacyPage() {
  ...
  const whatsappLink = `https://wa.me/${whatsappUsername}?text=${encodeURIComponent("Hello, I have a question about the Privacy Notice.")}`;

  const markdownContent = privacy.body.join("\n\n");

  return (
    <section className="bg-[var(--color-background)] py-12 sm:py-16">
      <div className="site-container max-w-3xl">
        <header className="mb-10 animate-fade-in-up">
          <SectionHeading eyebrow="Legal" title={privacy.title} />
        </header>
        ...
        <div className="mt-8 animate-fade-in-up delay-2">
          <p className="text-sm text-[var(--color-muted)] text-center">
            ...
            <Link href="/cookie-information" className="text-[var(--color-accent)] hover:underline font-medium">
              Cookie Information
            </Link>
            .
          </p>
