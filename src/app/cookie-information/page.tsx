...
export default function CookiePage() {
  const cookies = legalContent.cookies;
  const { whatsappUsername, email: contactEmail } = getContactConfig();
  const whatsappLink = `https://wa.me/${whatsappUsername}?text=${encodeURIComponent("Hello, I have a question about the Cookie Information.")}`;

  const markdownContent = cookies.body.join("\n\n");
      ...
      <div className="site-container max-w-3xl">
        ...
        <div className="mt-12 animate-fade-in-up delay-2">
          ...
          <div className="mt-6 card p-6">
            <p className="text-[var(--color-muted)]">
              If you have any questions about this Cookie Information, please contact us:
            </p>
        ...
        <div className="mt-8 animate-fade-in-up delay-2">
          <p className="text-sm text-[var(--color-muted)] text-center">
            For information about how we process your personal data, please see our{" "}
            <Link href="/privacy-notice" className="text-[var(--color-accent)] hover:underline font-medium">
              Privacy Notice
            </Link>
            .
          </p>
