...
export default function TermsPage() {
  ...
  const whatsappLink = `https://wa.me/${whatsappUsername}?text=${encodeURIComponent("Hello, I have a question about the Terms & Conditions.")}`;

  // Join body paragraphs into a single markdown string
  const markdownContent = terms.body.join("\n\n");
